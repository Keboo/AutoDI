    ...
    public class CSharpCodeGeneratorTests
    {
        ...
        public void CanGenerateGenericClass()
        {
            ...
            string expected =
                ...
                "    {" + Environment.NewLine +
                "        //Generated by AutoDI" + Environment.NewLine +
                $"        public {nameof(CSharpCodeGenrationTestsNamespace.Class2<object>)}({nameof(CSharpCodeGenrationTestsNamespace)}.{nameof(CSharpCodeGenrationTestsNamespace.IService)} foo, {nameof(CSharpCodeGenrationTestsNamespace)}.{nameof(CSharpCodeGenrationTestsNamespace.IService2)} bar)" + Environment.NewLine +
                "        {" + Environment.NewLine +
                "            //We now return you to your regularly scheduled method" + Environment.NewLine +
                "        }" + Environment.NewLine +
                "    }" + Environment.NewLine +
        ...
        public void CanGenerateNestedClass()
        {
            ...
            string expected =
                ...
                "        {" + Environment.NewLine +
                "            //Generated by AutoDI" + Environment.NewLine +
                $"            public {nameof(CSharpCodeGenrationTestsNamespace.Outer.Nested)}({nameof(CSharpCodeGenrationTestsNamespace)}.{nameof(CSharpCodeGenrationTestsNamespace.IService)} foo)" + Environment.NewLine +
                "            {" + Environment.NewLine +
                "                //We now return you to your regularly scheduled method" + Environment.NewLine +
                "            }" + Environment.NewLine +
                "        }" + Environment.NewLine +
