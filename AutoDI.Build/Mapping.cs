...
internal class Mapping : IEnumerable<Registration>
{
    ...
    private readonly List<Registration> _internalMaps = new();
    ...
    private static Lifetime? GetLifetime(TypeDefinition targetType, Lifetime? @default)
    {
        ...
        return mapAttribute != null ? (Lifetime)mapAttribute.ConstructorArguments.Single(x => x.Type.IsType<Lifetime>()).Value : @default;
    }
